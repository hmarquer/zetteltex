...
- **Doble pasada y bibliografía**: El comando `render` soporta compilaciones complejas con múltiples pasadas de `pdflatex` y la invocación de `biber` si es necesario, tanto para notas como para proyectos.
