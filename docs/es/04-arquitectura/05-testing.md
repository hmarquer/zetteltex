...
Estrategia de validación para asegurar la estabilidad del CLI de Rust y la integridad del Zettelkasten.
...
Para ejecutar solo los smoke tests de integración:

```bash
cargo test --test cli_smoke -p zetteltex-cli
```
